  ...
  template: `
    <div class="w-full">
      <div class="text-center py-5">
        <h2 style="font-size: 20px">Add New Post</h2>
        <p>You can add your new post here!</p>
      </div>
          ...
          <div class="w-[70%] grid grid-cols-5 gap-6 ">
            <div class="col-span-3 px-2"
              ...
              <div class="py-2">
                ...
                <textarea name="title" id="title" class="block w-full rounded-[5px] border-0 py-1.5 pl-2 pr-2 text-gray-900
